...
public class PollFirestoreTest {
	...
	@Test
	public void shouldGiveEmptyListWhenRecurringDateIsNotYetInThePast() {
		List<RecurringWatering> recurringWateringList = new ArrayList<>();
		RecurringWatering recurringWatering = new RecurringWatering();
		...
		Assert.assertEquals(0,pollFirestore.checkIfAnyRecurringWateringShouldBeDone(recurringWateringList, latestCheckDate, nowDate).size());
	}
